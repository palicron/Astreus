...
#include "ASTRAEUSSportsCar.h"
#include "ASTRAEUSSportsWheelFront.h"
#include "ASTRAEUSSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AASTRAEUSSportsCar::AASTRAEUSSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UASTRAEUSSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UASTRAEUSSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UASTRAEUSSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UASTRAEUSSportsWheelRear::StaticClass();
