...
#include "ASTRAEUSOffroadCar.h"
#include "ASTRAEUSOffroadWheelFront.h"
#include "ASTRAEUSOffroadWheelRear.h"
...
AASTRAEUSOffroadCar::AASTRAEUSOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UASTRAEUSOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UASTRAEUSOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UASTRAEUSOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UASTRAEUSOffroadWheelRear::StaticClass();
